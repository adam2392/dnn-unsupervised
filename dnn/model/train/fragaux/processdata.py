    ...
    def formatdata(self):
        ...
        for datafile in self.datafilepaths:
            ...
            for ichan in range(0, len(allinds)):
                ...
                beginwin, endwin = self.slicetimewins(timepoints, onsettimes, offsettimes)
        ...
        def loo():
            ...
            Xmain_train, Xmain_test,\
                Xaux_train, Xaux_test,\
                    y_train, y_test = loo(aux_data, main_data, ylabels)
            return Xmain_train, Xmain_test, Xaux_train, Xaux_test, y_train, y_test
        def randsplit():
            # format the data correctly 
            Xmain_train, Xmain_test,\
                Xaux_train, Xaux_test,\
                    y_train, y_test = train_test_split(aux_data, main_data, ylabels, test_size=0.33, random_state=42)
            return Xmain_train, Xmain_test, Xaux_train, Xaux_test, y_train, y_test
