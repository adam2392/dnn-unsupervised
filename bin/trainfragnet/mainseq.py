...
def maintrain(dnnmodel, datamunger, outputdatadir, tempdatadir):
    ...
    trainer = trainrnn.TrainRNN(dnnmodel, batch_size, NUM_EPOCHS, AUGMENT)
    ...
    trainer.loadtrainingdata_vars(Xmain_train, y_train)
    trainer.loadtestingdata_vars(Xmain_test, y_test)
    trainer.train()
